...
urlpatterns = [
    ...
    path('customer_dashboard/<str:pk>', views.customerDashboard, name="customer_dashboard"),
    path('customer_view_order/<str:pk>', views.CustomerViewOrder, name="customer_view_order"),
